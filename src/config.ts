...
const schema = z.object({
  ...
  TELEPHONY_ACCOUNT_ID: z.string().min(1).optional(), TELEPHONY_AUTH_TOKEN: z.string().min(1).optional(), TELEPHONY_PHONE_NUMBER: z.string().min(1).optional(), TELEPHONY_WEBHOOK_SECRET: z.string().min(1).optional(), VOICE_PROVIDER_API_KEY: z.string().min(1).optional()
});
